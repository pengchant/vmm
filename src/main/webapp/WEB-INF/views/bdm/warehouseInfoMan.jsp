...
<div class="easyui-layout" fit="true" border="false">
    <div region="center" border="false"> 
    	<table id="dg" title="仓库管理" fit="true"
		  toolbar="#toolbar" idField="id" rownumbers="true" fitColumns="true" pagination="true"
		  singleSelect="true"
		  pageSize="20">
		  	<thead>
		  		<tr>
		  			<th align="center" field="warehousename" width="50" editor="{type:'validatebox',options:{required:true}}">仓库名</th>
		  			<th align="center" field="warehouseadd" width="50" editor="{type:'validatebox',options:{required:true}}">仓库地址</th>
		  			<th align="center" field="remarks" width="50" editor="{type:'validatebox',options:{required:true}}">备注</th>
		  			<th align="center" field="wareflag" width="50" formatter="statusfm">标记</th>
